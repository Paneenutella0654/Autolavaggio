...
public class DBAccessView {
	...
	public DBAccessView() {
		...
		getFrmWelcome().getContentPane().setBackground(new Color(255, 255, 239));
		getFrmWelcome().setTitle("Accesso al DataBase");
		...
		txtAutola = new JTextPane();
		txtAutola.setEditable(false);
		txtAutola.setBackground(new Color(255, 255, 239));
		txtAutola.setFont(new Font("Black Italic", Font.PLAIN, 23));
		txtAutola.setText("Gestione Autolavaggio");
		getFrmWelcome().getContentPane().add(txtAutola, "cell 0 0 5 1,alignx center,aligny center");
		...
		txtServer.setToolTipText(" Ip del database");
		...
		txtPorta.setToolTipText(" Porta del database");
		...
		txtDbName.setToolTipText("Nome del database");
		...
		txtUser.setToolTipText("L'username per l'accesso al db");
